...
All in all, I'm not sure if there's anything to be learned from this, I just wanted to write my thoughts about down somewhere. There's probably some lessons to be learned when it comes to your own game, like understanding the genre you're in, and what players of that genre expect. Someone who plays fighting games wants to be rewarded for mastering the game, and want to feel like their choice of action and execution matters, while someone that plays cozy games doesn't really want to think that hard. This won't apply to every player, and that should be kept in mind as well.

I think Chaos Zero Nightmare put itself in a difficult spot, given the difference between someone that enjoys rogue-likes (in my opinion), and a gacha player. I wouldn't fault the developers for this, but it's definitely quite the challenge, game design wise, and I think that ultimately what drew me to the game in the first placem, isn't something that's really compatible with the way it's developing, which lead to me quitting the game.
