---
layout: post
title: Why I quit Chaos Zero Nightmare
subtitle: The challenge of balancing difficulty and casual gaming
thumbnail-img: /assets/img/Posts/owen.webp
cover-img: /assets/img/Posts/post-2-cover.jpg
share-img: /assets/img/Posts/Share img.png
tags: [Gaming]
author: Vogy Bear
---
<head>
...
*Before I begin, I'd like to say that this has nothing to do with Dreadwinter. I had a train of thought going and I wanted somewhere to write it down, and my own blog seemed like a good place to go. I'm not sure why I'm justifying this on my own website, to be honest.*

I was looking at a reddit post about changes that were being made to Chaos Zero Nightmare for it's half-anniversary, and I took a look at the comments, which were mostly talking about flaws in the game. This got me thinking about why I stopped playing a while ago, and what I thought the main problems were, some of which I think is down to the difficulty of making a game of the genre it's in, in contrast to the game's intended audience.
...
The main draw of the game (at least what I think) is it's Chaos Mode, which is the dungeon crawler gameplay, where you take a team of characters through a dungeon, making your way through multiple levels, consisting of either combat, choice events, or a rest zone, until you take on the big boss at the end of the dungeon. You have a deck of cards, which depends on the characters you're using, and you can upgrade or obtain cards over the course of your run. There's some other things that happen as well, but that's the gist of it.

There's also the usual gameplay you see in popular gachas, such as material farming, a story mode, and your endgame content, which is generally defeating a set of enemies as fast as possible.

If you've played Slay the Spire, and you've played a gacha game before, you can probably get the idea.
...
The thing is, I genuinely did enjoy the game at the start. I think that this was because at the start of the game I didn't have many characters, and they weren't levelled, which made Chaos runs quite challenging. There was a high chance that I would get wiped if I messed up during a run, and I had to make careful decisions about which node I went to next, and manage my resources (health and stress) carefully during battles.

When the brain is engaged like this, a run taking an hour or two isn't a problem, since I wouldn't even notice the time passing, and I might even say it was a good use of an hour. The issue is, however, that at a certain point, this stops happening. 

With a game like Slay the Spire, you have an ascension mode, which increases the difficulty from the base one, and there are many levels to this. This keeps the game challenging, and as you go up in difficulty, certain strategies become less viable, and you have to change how you play, which is refreshing. There's only a small amount of characters, and they come as-is, so they won't get any better or worse.
...
This is why I think that the Slay the Spire-esque gameplay, and rogue-likes in general, don't really fit with the way that a gacha game works. With a rogue-like, you play for the challenge, hoping that with a bit of luck and your skill, you can finally clear a run. But with a gacha game, you don't want challenge (despite what you may think), you want the game to become easier. It's not really satisfying if you dump a load of money in to get your favourite character and the game becomes harder as a reward, it's supposed to be the other way around. The developers know this, and they need to make money, and keep the player count up, so the game gets balanced around the casual players and whales (people who spend large amounts of money).

# A lack of incentive

So I stopped enjoying Chaos mode, and the only reason I would play it would be to get a good build for endgame, but here lies another issue, one that you might find a bit odd.
...
All in all, I'm not sure if there's anything to be learned from this, I just wanted to write my thoughts about the game down somewhere. There's probably some lessons to be learned when it comes to your own game, like understanding the genre you're in, and what players of that genre expect. Someone who plays fighting games wants to be rewarded for mastering the game, and want to feel like their choice of action and execution matters, while someone that plays cozy games doesn't really want to think that hard. Therefore, it might be difficult to make a cozy fighter game, since the two playerbases are very different. This won't apply to every player, and that should be kept in mind as well.

I think Chaos Zero Nightmare put itself in a difficult spot, given the difference between someone that enjoys rogue-likes (in my opinion), and a gacha player. I wouldn't fault the developers for this, but it's definitely quite the challenge, game design wise, and I think that ultimately what drew me to the game in the first place, isn't something that's really compatible with the way it's developing, which lead to me quitting the game.

That being said, I do think it's worth trying out, and I wouldn't tell you not to play it. Gacha games are quite dangerous if you don't have good financial control, so that's the only reason I would have against it. Really, you should play Dreadwinter instead!
